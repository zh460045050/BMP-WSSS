...
class VOC12Dataset(Dataset):
    def __init__(
        ...
        self.stage = stage
        if self.stage == "test":
            self.img_dir = os.path.join(root_dir, 'JPEGImages_test')
        else:
...
class VOC12Dataset_WS(Dataset):
    def __init__(
        ...
        if self.stage == "test":
            ...
            self.img_dir = os.path.join(root_dir, 'JPEGImages')
        #self.label_dir = os.path.join(root_dir, 'SegmentationClassAug')
        self.label_dir = os.path.join(label_dir)
        self.name_list_dir = os.path.join(name_list_dir, split + '.txt')
        self.name_list = load_img_name_list(self.name_list_dir)
...
class VOC12SegDataset_WS(VOC12Dataset_WS):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
        ...
        super().__init__(root_dir, name_list_dir, split, stage, label_dir)
...
class VOC12Dataset_WS_np(Dataset):
    def __init__(
        self,
        root_dir=None,
        name_list_dir=None,
    ...
    def __getitem__(self, idx):
        ...
        if self.stage == "train":
            ...
            #label_dir = os.path.join(self.label_dir, _img_name+'.png')
            #label = np.asarray(imageio.imread(label_dir))
            label_dir = os.path.join(self.label_dir, _img_name+'.npy')
            label = np.load(label_dir)
            label[label < self.thresh] = 0
...
class VOC12SegDataset_WS_np(VOC12Dataset_WS_np):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
